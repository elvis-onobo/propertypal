    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Upload a Property Without Picture</div>

                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ url('withoutPictureUpload') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                            ...
                            <div class="col-md-6">
                                <select id="password-confirm" type="text" class="form-control" name="water" required>
                                    @if(count($evaluation) > 0)
                                        @foreach($evaluation->all() as $evaluations)
                                            <option value="{{ $evaluations->id }}">{{ $evaluations->evaluation }}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
